		...
		<section class="feature-area pt-100 pb-100  relative">
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-12">
						<div class="story-content">
							<?php echo $storycontentheader0;?>
							<p class="text-white">
								<?php echo $storycontentdetail0;?>
							</p>
						</div>
						<div class="story-content">
							<?php echo $storycontentheader1;?>
							<p class="text-white">
								<?php echo $storycontentdetail1;?>
							</p>
						</div>
						<div class="story-content">
							<?php echo $storycontentheader2;?>
							<p class="text-white">
								<?php echo $storycontentdetail2;?>
							</p>
			...
			<div class="container">
				<div class="row">
					<div class="counter-left col-lg-3 col-md-3">
						...
						<div class="single-facts">
							<h2 class="counter">2,253,687,806</h2>
							<p>Volume transportation per year</p>
						</div>
						<div class="single-facts">
							<h2 class="counter">12</h2>
							<p>Transportation Ships</p>
						</div>
					</div>
					<div class="faq-content col-lg-9 col-md-9">
						<div class="single-faq">
							...
							<p>	<table border='0' width='100%'>
									<tr height='130' valign='middle'>
										<td>
											<img src='client/ptt.png' width='250'>
										</td>
										<td>
											<img src='client/irpc.png' width='250'>
										</td>
									</tr>
									<tr height='130' valign='middle'>
										<td>
											<img src='client/bangchak.png' width='250'>
										</td>
										<td>
											<img src='client/sprc.png' width='250'>
										</td>
									</tr>
									<tr height='130' valign='middle'>
										<td>
											<img src='client/chevron.png' width='250'><bR>
										</td>
										<td>
											&nbsp;
										</td>
			...
			<div class="container">
				<div class="row justify-content-center text-center">
					<div class="single-contact col-lg-6 col-md-8">
						<?php echo $contactus_header?>
						<?php echo $contactus_detail?>
					</div>
				</div>
